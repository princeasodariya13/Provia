...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      <Hero3D />
      {/* Left text vignette — keeps text readable without hiding center animation */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#050508]/85 via-[#050508]/20 to-transparent pointer-events-none z-[1]" />
      {/* Bottom section transition */}
      <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-[#050508] to-transparent pointer-events-none z-[1]" />
