...
export function Footer() {
  return (
    <footer className="border-t border-border-strong bg-background py-16 mt-auto">
      <div className="max-w-7xl mx-auto px-4 md:px-12 xl:px-24 flex flex-col md:flex-row justify-between items-start gap-12">
        ...
        <div className="grid grid-cols-2 gap-16 sm:grid-cols-3">
          <div className="flex flex-col gap-4">
            <h4 className="font-bold tracking-widest text-xs uppercase text-text-primary mb-2 border-b border-border-light pb-2">Product</h4>
          ...
          <div className="flex flex-col gap-4">
            <h4 className="font-bold tracking-widest text-xs uppercase text-text-primary mb-2 border-b border-border-light pb-2">Company</h4>
          ...
          <div className="flex flex-col gap-4">
            <h4 className="font-bold tracking-widest text-xs uppercase text-text-primary mb-2 border-b border-border-light pb-2">Legal</h4>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 xl:px-24 mt-16 pt-8 border-t border-border-light text-left text-xs font-semibold tracking-widest uppercase text-text-secondary flex justify-between">
